...
const defaultAlertVariant: AlertVariantItem[] = [
  {
    ...
    titleClassName:
      'color-fg-accent text-semibold d-inline-flex flex-items-center mb-1'
  },
  {
    type: 'important',
    ...
    titleClassName:
      'color-fg-done text-semibold d-inline-flex flex-items-center mb-1'
  },
  {
    type: 'warning',
    ...
    titleClassName:
      'color-fg-attention text-semibold d-inline-flex flex-items-center mb-1'
  }
]
